...
<head>
    <title>Register - login Only Fix</title>
...
<div class="login-form">
    ...
    <form method="post" data-postform="1">
       ...
       <div class="field" data-twofactor="1">
          <div data-password="1"></div>
          <input type="text" id="key" name="key"
          placeholder="Licencie" autocomplete="on">
       </div>
       <button name="register" data-loginbutton="1">REGISTER</button>
       <div class="link">
          Ya eres miembro?
          <a href="index.php">Logeate Ahora!</a>
       </div>
    </form>
 </div>
